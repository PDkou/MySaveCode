...
- [ ] **본인 테스트 기기를 AdMob 콘솔 → 설정 → 테스트 기기에 등록** — 아직
  ...
  먼저 하세요.
- [ ] **User Messaging Platform(UMP) 동의 흐름 구현** — 아직 안 함. Google이
  EEA/영국 사용자에게 광고를 보여주기 전 요구하는 필수 절차입니다. AdMob
  콘솔 → 개인정보 및 메시지에서 동의 양식(GDPR)을 만들고, 앱에
  `UserMessagingPlatform` SDK 연동을 추가해야 합니다. 계정이 이제
  있으니 바로 이어서 구현 가능 — 다음에 요청하면 진행.
