...
// wasn't part of this asset drop. (An earlier pass rebuilt that layered
// animation by hand in CSS/SVG instead of using this real artwork -- it
// read as generic flat shapes next to the actual icon, so this reverts to
// the real image.)
