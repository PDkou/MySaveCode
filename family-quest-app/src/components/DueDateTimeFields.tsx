...
export function DueDateTimeFields({ value, onChange }: DueDateTimeFieldsProps) {
  ...
  // Native date/time pickers otherwise follow the browser/OS locale, not
  // the app's own language toggle -- setting lang explicitly here is what
